...
#define DESC_FLAG_IMM BIT(8)	/* A6L: IPA immediate command (downstream SPS_IOVEC_FLAG_IMME 0x0100) */
...
static const struct of_device_id bam_of_match[] = {
	/* A6L fork: only the IPA BAM, described with a private compatible by a6l-ipa-v75.dtso */
	{ .compatible = "a6l,ipa-bam-v1.7.0", .data = &bam_v1_7_reg_info },
	{}
};
...
MODULE_DESCRIPTION("QCOM BAM DMA engine driver (A6L IPA fork: metadata + immediate commands)");
