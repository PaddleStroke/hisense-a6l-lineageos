...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-request-kernel-v26-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-request-v26.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-request-v26.log "$archive/build.log"
printf '\nA6L_STORAGE_REQUEST_KERNEL_BUILD_SUCCESS\n'
