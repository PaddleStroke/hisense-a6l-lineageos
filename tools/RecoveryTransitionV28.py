...
PREVIOUS = 'a52505613120c8635d67947b76f937b6615b96665a408e75a119843183fcbdf6'
RECOVERIES = {STOCK: 'stock', PREVIOUS: 'verified-v27'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    if recovery_digest not in RECOVERIES:
        raise ValueError('Existing recovery is neither exact stock nor the verified V27 image')
