...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-cmd0-kernel-v25-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-cmd0-v25.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-cmd0-v25.log "$archive/build.log"
printf '\nA6L_STORAGE_CMD0_KERNEL_BUILD_SUCCESS\n'
