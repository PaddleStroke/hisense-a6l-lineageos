...
"""
import argparse
from RecoveryTransitionV22 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV22 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v22' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v22'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v22.img').read_bytes()
