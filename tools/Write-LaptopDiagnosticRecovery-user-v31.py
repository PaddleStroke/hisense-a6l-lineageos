...
"""
import argparse
from RecoveryTransitionV31 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV31 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v31' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v31'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v31.img').read_bytes()
