...
CAPTURE = ROOT / 'capture-probe-serial-user-v38'
SERIAL = '1e529013'
...
def main():
    ...
    try:
        ...
        if not all(word in inhibition for word in ['A6L-v38', 'suspend', 'idle']):
            raise RuntimeError('V38 requires an active desktop idle/suspend inhibitor')
