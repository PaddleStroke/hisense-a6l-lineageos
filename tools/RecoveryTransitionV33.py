...
PREVIOUS = '47a31604c4d41743406201c85ae5ea7eb68999cf3bb0a41756c3a5bf224f9278'
RECOVERIES = {STOCK: 'stock', PREVIOUS: 'verified-v32'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    if recovery_digest not in RECOVERIES:
        raise ValueError('Existing recovery is neither exact stock nor the verified V32 image')
