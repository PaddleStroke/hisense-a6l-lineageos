#!/usr/bin/env python3
"""Package the pin-controller trace diagnostic after diskless emulator checks."""
import gzip
import hashlib
...
OUT = ROOT / 'firmware/extracted/recovery-probe-pinctrl-20260915'
...
def main():
    ...
    report = dict(scope='Offline pin-controller logging candidate; no phone access',
