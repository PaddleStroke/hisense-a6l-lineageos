"""Independently verify all twelve copied V74 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV74 as transition
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v74'
