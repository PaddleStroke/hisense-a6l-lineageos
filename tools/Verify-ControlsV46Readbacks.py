"""Independently verify all twelve copied V46 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV46 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = 'ce3727dda592065becb883ef3fe663cb3579290edb841854e01f4fc49d02a3c6'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v46'
