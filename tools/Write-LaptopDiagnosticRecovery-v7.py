...
from DiagnosticRecoveryProtocolV6 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v7' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v7'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-gpio-reserved.img').read_bytes()
