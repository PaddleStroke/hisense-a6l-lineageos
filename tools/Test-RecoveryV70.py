#!/usr/bin/env python3
"""V70 candidate: regression-check against the captured ABL routines (generated from the V46 test)."""
import hashlib
...
def main():
    ...
    try:
        ...
        expected_base = read_fdt((ROOT / 'firmware/extracted/recovery-v69-candidate-20260921/base.dtb').read_bytes())
        ...
        for node, props in read_fdt(base).items():  # V70: property-less container nodes (e.g. pmic@68/regulators)
            if not props:
