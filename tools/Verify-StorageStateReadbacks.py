"""Independently verify all twelve copied V32 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV32 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = '47a31604c4d41743406201c85ae5ea7eb68999cf3bb0a41756c3a5bf224f9278'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v32'
