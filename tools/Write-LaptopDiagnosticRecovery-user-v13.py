...
from DiagnosticRecoveryProtocolV13 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v13' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v13'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v13.img').read_bytes()
