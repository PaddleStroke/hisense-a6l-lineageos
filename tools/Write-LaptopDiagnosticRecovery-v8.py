...
from DiagnosticRecoveryProtocolV7 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v8' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v8'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-init-milestones.img').read_bytes()
