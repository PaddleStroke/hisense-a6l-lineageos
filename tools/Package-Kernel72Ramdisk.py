...
OUT = ROOT / 'firmware/extracted/baseline-7.2-ramdisk-20260917'
...
report = dict(packaging_passed=True, init_sha256=sha(init), source_sha256=sha(source),
              ...
              scope='Same verified RAM logger; matching 7.2.3 eMMC module; no persistent mounts or block-device opens')
