...
PREVIOUS = 'da70c8383db73370f75af2838f2701efcab5901a183d8318b7a67c760f3104b6'
RECOVERIES = {STOCK: 'stock', PREVIOUS: 'verified-v28'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    if recovery_digest not in RECOVERIES:
        raise ValueError('Existing recovery is neither exact stock nor the verified V28 image')
