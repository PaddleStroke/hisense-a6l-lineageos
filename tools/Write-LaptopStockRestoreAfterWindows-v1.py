...
from DiagnosticRecoveryProtocolV11 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v12' if args.mode == 'install-diagnostic' else 'capture-stock-restore-after-windows-v1'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-usb-only.img').read_bytes()
