...
printf 'obj-m += panel-ft8719-tianma-1080x2340.o panel-epd-eink.o tc358762-a6l.o\n' > $M/Makefile
...
for m in panel-ft8719-tianma-1080x2340 panel-epd-eink tc358762-a6l; do llvm-strip --strip-debug -o $M/$m.s.ko $M/$m.ko; cat $M/$m.s.ko > $A/$m.ko; done
