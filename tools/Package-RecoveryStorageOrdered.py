...
OLD = ROOT / 'firmware/extracted/recovery-probe-storage-commit-v30-20260916'
RAM = ROOT / 'firmware/extracted/storage-ordered-ramdisk-v31-20260916'
TEST = ROOT / 'firmware/extracted/storage-ordered-probe-v31-20260916'
...
def main():
    ...
    assert test['passed']
    assert json.loads((ROOT / 'firmware/extracted/storage-ordered-smoke-v31-20260916/report.json').read_text())['passed']
    kernel = (TEST / 'Image.a6l-offset').read_bytes()
    assert sha(kernel) == test['kernel_sha256'] == '1cac2b81609f4134d74c079381dce76b1cedfbcae2563dcfaf4e935c367c5ce7'
    ...
    assert sha(original) == '81c874f0a9112c09631bcf8f5250190ddb7ecc3f255317ac178f71ef3bbb03e8'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V31 first-CMD0 stock-style store barrier and early CDR flag trace; same staged success/error branches, DT and init; matching changed module',
