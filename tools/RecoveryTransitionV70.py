...
PREVIOUS = '4dc4861ebcbd30b5f38ab236b3bdb37e57140803dca1b993d4749808c2815eec'

RECOVERIES = {PREVIOUS: 'verified-v69'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    ...
    if recovery_digest not in RECOVERIES:
        ...
        raise ValueError('Existing recovery is not the verified V69 predecessor')
