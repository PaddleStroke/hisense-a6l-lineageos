#!/usr/bin/env python3
"""Replace only the tested V13 diagnostic ramdisk; no phone access."""
import hashlib
...
OLD = ROOT / 'firmware/extracted/recovery-probe-staged-usb-v13-20260916'
RAM = ROOT / 'firmware/extracted/staged-usb-ramdisk-v14-20260916'
TEST = ROOT / 'firmware/extracted/staged-usb-probe-v14-20260916'
...
def main():
    ...
    assert sha(original) == 'f302bc49910f0c1595590b5dc7ac062f86681ff9b26233142e93cb8e501c661e'
    ...
    report = dict(packaging_passed=True, ready_to_flash=False,
                  scope='Only RAM diagnostic replacement; kernel, DT, command line and load addresses unchanged from V13',
