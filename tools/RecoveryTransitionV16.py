...
PREVIOUS = '7dbab370e9580ec3ac25bd24a9edadfedef5334447a754d83b789a72d0b1271d'
RECOVERIES = {STOCK: 'stock', PREVIOUS: 'verified-v15'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    if recovery_digest not in RECOVERIES:
        raise ValueError('Existing recovery is neither exact stock nor the verified V15 image')
