...
def main():
    ...
    try:
        ...
        previous_tree = read_fdt((ROOT / 'firmware/extracted/recovery-probe-storage-state-v32-20260917/base.dtb').read_bytes())
        assert previous_tree['/soc@0/mmc@c0c4000']['resets'] == bytes.fromhex('000000200000000a')
        del previous_tree['/soc@0/mmc@c0c4000']['resets']
        assert read_fdt(base) == previous_tree
