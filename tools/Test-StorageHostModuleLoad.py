...
KERNEL = ROOT / 'firmware/extracted/storage-host-kernel-v23-20260916'
OUT = Path('/home/a6l/kernel/test-storage-host-smoke-v23-20260916')
ARCHIVE = ROOT / 'firmware/extracted/storage-host-smoke-v23-20260916'
