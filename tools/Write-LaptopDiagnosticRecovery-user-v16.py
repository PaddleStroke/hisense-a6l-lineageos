...
"""
import argparse
from RecoveryTransitionV16 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV16 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v16' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v16'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v16.img').read_bytes()
