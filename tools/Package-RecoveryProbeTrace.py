#!/usr/bin/env python3
"""Package the probe-entry trace diagnostic after diskless emulator checks."""
import gzip
import hashlib
...
EARLY = ROOT / 'firmware/extracted/earlycon-trace-probe-v3-20260915'
...
def main():
    ...
    report = dict(scope='Offline probe-entry logging candidate; no phone access',
