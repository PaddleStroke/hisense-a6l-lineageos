"""Independently verify all twelve copied V15 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV15 as transition
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v15'
