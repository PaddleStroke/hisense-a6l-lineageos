...
CAPTURE = ROOT / 'capture-surface-user-v44'
SERIAL = '1e529013'
...
def main():
    ...
    report = {'scope': 'Reuse V38 recovery for V44 RAM graphics services; one bootloader restart, no image writes',
    ...
    try:
        ...
        if not all(word in inhibition for word in ['A6L-v44', 'suspend', 'idle']):
            raise RuntimeError('V44 requires an active desktop idle/suspend inhibitor')
