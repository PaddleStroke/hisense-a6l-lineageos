"""Package V19 RAM init and its matching eMMC module; no device access."""
import gzip
import hashlib
import json
...
OUT = ROOT / 'firmware/extracted/storage-module-ramdisk-v19-20260916'
...
assert b'A6L_STORAGE_MODULE_LOAD_BEGIN' in data and b'A6L_STORAGE_SNAPSHOT_DONE' in data
