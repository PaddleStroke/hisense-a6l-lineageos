...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-commit-kernel-v30-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-commit-v30.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-commit-v30.log "$archive/build.log"
