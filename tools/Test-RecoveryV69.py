#!/usr/bin/env python3
"""V69 candidate: regression-check against the captured ABL routines (generated from the V46 test)."""
import hashlib
...
def main():
    ...
    try:
        ...
        expected_base = read_fdt((ROOT / 'firmware/extracted/recovery-v68-candidate-20260920/base.dtb').read_bytes())
        ...
        for node, props in read_fdt(base).items():  # V69: property-less container nodes (e.g. pmic@68/regulators)
            if not props:
