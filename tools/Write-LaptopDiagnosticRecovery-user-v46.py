...
"""
import argparse
from RecoveryTransitionV46 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV46 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v46' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v46'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v46.img').read_bytes()
