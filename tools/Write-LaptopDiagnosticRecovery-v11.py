...
from DiagnosticRecoveryProtocolV10 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v11' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v11'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-regulator-constraints.img').read_bytes()
