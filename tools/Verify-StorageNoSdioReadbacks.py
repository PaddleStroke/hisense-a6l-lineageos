"""Independently verify all twelve copied V27 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV27 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = 'a52505613120c8635d67947b76f937b6615b96665a408e75a119843183fcbdf6'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v27'
