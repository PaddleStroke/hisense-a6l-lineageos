...
ARCHIVE = ROOT / 'firmware/extracted/storage-state-probe-v32-20260917'
# Keep actively written QEMU logs on Linux ext4, not the Windows shared mount.
OUT = Path('/home/a6l/kernel/test-storage-state-probe-v32-20260917')
...
'''
    ...
    args = ['qemu-system-aarch64', '-machine', 'virt,gic-version=3', '-cpu', 'cortex-a53',
            ...
            '-initrd', str(ROOT / 'firmware/extracted/storage-state-ramdisk-v32-20260917/ramdisk.cpio.gz'),
...
def main():
    ...
    image = (ROOT / 'firmware/extracted/storage-state-kernel-v32-20260917/Image').read_bytes()
    ...
    result = {'scope': 'Diskless QEMU test of staged RAM PID1 through 22 seconds; no physical USB emulation',
              ...
              'ramdisk_sha256': hashlib.sha256((ROOT / 'firmware/extracted/storage-state-ramdisk-v32-20260917/ramdisk.cpio.gz').read_bytes()).hexdigest(), 'cases': {}}
    try:
