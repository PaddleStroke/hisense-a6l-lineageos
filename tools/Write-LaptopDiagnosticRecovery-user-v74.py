...
"""
import argparse
from RecoveryTransitionV74 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV74 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v74' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v74'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v74.img').read_bytes()
