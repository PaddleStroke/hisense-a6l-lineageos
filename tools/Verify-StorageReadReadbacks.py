"""Independently verify all twelve copied V37 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV37 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = '7de9a96229140b066aed2724ccf2cb14b1a09cc9e44a12bfb25ee4543761b8e9'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v37'
