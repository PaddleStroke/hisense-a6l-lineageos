...
CAPTURE = ROOT / 'capture-display-user-v40'
SERIAL = '1e529013'
...
def main():
    ...
    report = {'scope': 'Reuse V38 recovery for V40 RAM display; one bootloader restart, no image writes',
    ...
    try:
        ...
        if not all(word in inhibition for word in ['A6L-v40', 'suspend', 'idle']):
            raise RuntimeError('V40 requires an active desktop idle/suspend inhibitor')
