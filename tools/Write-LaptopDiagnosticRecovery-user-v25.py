...
"""
import argparse
from RecoveryTransitionV25 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV25 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v25' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v25'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v25.img').read_bytes()
