...
"""
import argparse
from RecoveryTransitionV26 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV26 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v26' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v26'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v26.img').read_bytes()
