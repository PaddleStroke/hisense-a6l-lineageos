#!/usr/bin/env python3
"""Package the GPIO 8-11 reservation with the already tested pinctrl trace kernel."""
import gzip
import hashlib
...
OUT = ROOT / 'firmware/extracted/recovery-probe-gpio-reserved-20260915'
EARLY = ROOT / 'firmware/extracted/pinctrl-trace-probe-20260915'
...
def main():
    ...
    report = dict(scope='Offline GPIO reservation candidate; no phone access',
                  ...
                  remaining=['Run captured ABL overlay, selection, fixup and packaging checks',
                             ...
                             'Early LCD console already demonstrated physically; new trace image still requires a physical trial'],
