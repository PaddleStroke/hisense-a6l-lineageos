#!/usr/bin/env python3
"""V68 candidate: regression-check against the captured ABL routines (generated from the V46 test)."""
import hashlib
...
def main():
    ...
    try:
        ...
        expected_base = read_fdt((ROOT / 'firmware/extracted/recovery-controls-v46-20260918/base.dtb').read_bytes())
