...
"""
import argparse
from RecoveryTransitionV38 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV38 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v38' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v38'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v38.img').read_bytes()
