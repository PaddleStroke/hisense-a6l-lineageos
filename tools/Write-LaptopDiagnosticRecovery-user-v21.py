...
"""
import argparse
from RecoveryTransitionV21 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV21 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v21' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v21'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v21.img').read_bytes()
