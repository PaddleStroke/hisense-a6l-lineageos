...
"""
import argparse
from RecoveryTransitionV35 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV35 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v35' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v35'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v35.img').read_bytes()
