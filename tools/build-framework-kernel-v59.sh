#!/usr/bin/env bash
# V59 offline runtime/QEMU kernel: V50 configuration + built-in Android networking
# (netd/iptables/BPF classifier requirements). Never updates a phone or a validated image.
set -euo pipefail
workspace=/mnt/c/Users/Pierre/Desktop/A6L
kernel_dir=/home/a6l/kernel/a6l-baseline-7.2
out=/home/a6l/kernel/out-a6l-framework-v59
v50=$workspace/firmware/extracted/framework-kernel-v50-20260918
archive=$workspace/firmware/extracted/framework-kernel-v59-$(date +%Y%m%d)
module_dir=/home/a6l/kernel/a6l-simplefb-framework-v59
...
make O="$out" ARCH=arm64 LLVM=1 -j14 modules > "$out/modules-build.log" 2>&1
cp "$v50/a6l_simplefb.c" "$module_dir/"; printf 'obj-m += a6l_simplefb.o\n' > "$module_dir/Makefile"
...
cp "$0" "$archive/"
printf '\nA6L_FRAMEWORK_KERNEL_V59_BUILD_PASS\n'
