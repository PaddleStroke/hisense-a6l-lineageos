...
def main():
    ...
    assert sha(original) == '365b880a19edbf7945bc82ca672cc853ea90fd059aaf9a480bd7e43039666305'
    assert json.loads((OLD / 'captured-abl-validation.json').read_text())['passed']
    OUT.mkdir(exist_ok=False)
    base = (KERNEL / 'base.dtb').read_bytes()
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V34 Linux 6.19.10 SDM660 baseline; normal MMC core, A6L boot/USB support, optional LED bypass; same RAM init and board-specific settings as V33',
