...
def main():
    ...
    try:
        ...
        assert sha(candidate) == 'fa58e7102ed18480a8f248bbc5e0e97fc22e53600856120801d0bfde7747a79c'
        ...
        assert sha(kernel) == 'b96c37874a0585f7804886d09d68aafa790b80cc89088af689f4ac0f119153fd'
