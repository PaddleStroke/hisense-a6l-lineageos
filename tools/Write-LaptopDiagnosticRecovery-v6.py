...
from DiagnosticRecoveryProtocolV5 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v6' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v6'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-pinctrl.img').read_bytes()
