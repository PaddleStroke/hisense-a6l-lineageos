...
PREVIOUS = 'fa6319e61da7347b28f76527f8ff75dfeba2a6b3c7067de564ca85fe9123018e'
RECOVERIES = {STOCK: 'stock', PREVIOUS: 'verified-v36'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    if recovery_digest not in RECOVERIES:
        raise ValueError('Existing recovery is neither exact stock nor the verified V36 image')
