...
OLD = ROOT / 'firmware/extracted/recovery-probe-storage-cmd0-v25-20260916'
...
def main():
    ...
    assert sha(original) == '911de6c83d41a2be646a70e2b850f7d2aa795e937262c1b44c74ee2259e575e7'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V25 hardware settings and RAM init preserved; add five process-context pauses and bounded non-sleeping command/IRQ events',
