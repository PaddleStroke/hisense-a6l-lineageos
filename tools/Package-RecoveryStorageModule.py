...
OLD = ROOT / 'firmware/extracted/recovery-probe-storage-v18-20260916'
RAM = ROOT / 'firmware/extracted/storage-module-ramdisk-v19-20260916'
TEST = ROOT / 'firmware/extracted/storage-module-probe-v19-20260916'
...
def main():
    ...
    assert sha(kernel) == test['kernel_sha256'] == '4a93a3ef95ec44c820fdacf24085c68ce64718f27cdc7140cf676c14a744673c'
    ...
    assert sha(original) == 'a983ef25bdca4a06dae88ab74a4db8582b0a4507f01e14ad6bb2a9354c123ee6'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V18 device tree and USB preserved; only SDHCI_MSM changes to module, RAM init loads it at 20s after USB transmission; no persistent mounts',
