"""Independently verify all twelve copied V22 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV22 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = '19ea35f9ce8b97683c195aa2a26fce811170a04064483c539eddaba1782720d3'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v22'
