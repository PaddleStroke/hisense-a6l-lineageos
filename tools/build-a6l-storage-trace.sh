...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-trace-kernel-v20-r2-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-trace-v20-r2.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-trace-v20-r2.log "$archive/build.log"
printf '\nA6L_STORAGE_TRACE_KERNEL_BUILD_SUCCESS\n'
