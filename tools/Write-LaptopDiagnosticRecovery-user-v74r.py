...
"""
import argparse
from RecoveryTransitionV74R import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV74R import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v74r' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v74r'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v74r.img').read_bytes()
