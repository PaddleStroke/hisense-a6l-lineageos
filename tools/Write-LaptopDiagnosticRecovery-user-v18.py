...
"""
import argparse
from RecoveryTransitionV18 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV18 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v18' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v18'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v18.img').read_bytes()
