...
PREVIOUS = 'b93771e701d677c58e377feae794a25d3a9c4c1f5cd379bb904910e4661a4373'

RECOVERIES = {PREVIOUS: 'verified-v70'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    ...
    if recovery_digest not in RECOVERIES:
        ...
        raise ValueError('Existing recovery is not the verified V70 predecessor')
