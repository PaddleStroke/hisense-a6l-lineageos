...
OLD = ROOT / 'firmware/extracted/recovery-probe-staged-usb-v15-20260916'
RAM = ROOT / 'firmware/extracted/staged-usb-ramdisk-v16-20260916'
TEST = ROOT / 'firmware/extracted/staged-usb-probe-v16-20260916'
...
def main():
    ...
    assert sha(kernel) == test['kernel_sha256'] == '7bb565ac584a8ec05fa95145e22912a018c240bef7ffd7665dc62113f6587b70'
    ...
    assert sha(original) == '7dbab370e9580ec3ac25bd24a9edadfedef5334447a754d83b789a72d0b1271d'
    ...
    assert 'a6l_manual_usb=1' in old_cmdline and 'a6l_usb_trace' not in old_cmdline
    cmdline = old_cmdline + ' a6l_usb_trace=1'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'A6L opt-in bounded USB event trace, stages0/4/8/12 seconds; identical V15 DT, voltage constraints and load addresses',
