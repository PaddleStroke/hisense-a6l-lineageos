...
OLD = ROOT / 'firmware/extracted/recovery-probe-storage-ordered-v31-20260916'
...
def main():
    ...
    assert sha(original) == '0cb8efe9d42e3c1cd8114a6b6d17dde03a12ebb307a78e46a70419d34258d047'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V32 bounded pre-CMD0 controller/vendor/regulator state snapshot; same V31 write sequence, staged branches, DT and init; matching changed module',
