...
def main():
    ...
    try:
        ...
        prior = ROOT / 'firmware/extracted/recovery-probe-storage-request-v26-20260916'
        expected_dt = read_fdt((prior / 'base.dtb').read_bytes())
        expected_dt['/soc@0/mmc@c0c4000']['no-sdio'] = b''
        assert read_fdt((OUT / 'base.dtb').read_bytes()) == expected_dt
        assert (OUT / 'ramdisk.cpio.gz').read_bytes() == (prior / 'ramdisk.cpio.gz').read_bytes()
        ...
        assert sha(kernel) == '410642b760aeb08b304014d74b83b60831a88cd924ee5a541d247ecf8266b494'
