...
for part in Android.bp diagnostic/framework_root_services.c diagnostic/framework_root_properties.h; do
...
log=${A6L_FRAMEWORK_BUILD_LOG:-/home/a6l/logs/build-framework-root-v49-r1.log}
test ! -e "$log"
exec > >(tee "$log") 2>&1
