...
from DiagnosticRecoveryProtocolV4 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v5' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v5'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-trace.img').read_bytes()
