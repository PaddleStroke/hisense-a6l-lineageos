...
"""
import argparse
from RecoveryTransitionV24 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV24 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v24' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v24'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v24.img').read_bytes()
