"""Independently verify all twelve copied V28 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV28 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = 'da70c8383db73370f75af2838f2701efcab5901a183d8318b7a67c760f3104b6'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v28'
