"""Independently verify all twelve copied V23 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV23 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = 'fcc665755df0dfb3324f606701f8072dcdda3cef98227e416c593ba9ff113afa'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v23'
