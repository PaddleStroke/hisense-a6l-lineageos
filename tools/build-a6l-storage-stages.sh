...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-stages-kernel-v29-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-stages-v29.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-stages-v29.log "$archive/build.log"
printf '\nA6L_STORAGE_STAGES_KERNEL_BUILD_SUCCESS\n'
