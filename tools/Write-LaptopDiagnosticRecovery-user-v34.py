...
"""
import argparse
from RecoveryTransitionV34 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV34 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v34' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v34'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v34.img').read_bytes()
