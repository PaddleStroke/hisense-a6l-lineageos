...
ARCHIVE = ROOT / 'firmware/extracted/init-milestones-probe-20260915'
# Keep actively written QEMU logs on Linux ext4, not the Windows shared mount.
OUT = Path('/home/a6l/kernel/test-init-milestones-20260915')
...
def main():
    ...
    result = {'scope': 'Diskless QEMU executes and verifies the new late-init milestones through PID1; it does not emulate A6L physical display or USB hardware',
