...
"""
import argparse
from RecoveryTransitionV29 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV29 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v29' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v29'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v29.img').read_bytes()
