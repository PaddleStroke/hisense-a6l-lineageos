...
"""
import argparse
from RecoveryTransitionV27 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV27 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v27' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v27'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v27.img').read_bytes()
