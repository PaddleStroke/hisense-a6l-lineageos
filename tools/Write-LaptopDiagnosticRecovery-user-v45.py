...
"""
import argparse
from RecoveryTransitionV45 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV45 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v45' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v45'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v45.img').read_bytes()
