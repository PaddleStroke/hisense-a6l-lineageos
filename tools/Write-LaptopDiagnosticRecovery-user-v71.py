...
"""
import argparse
from RecoveryTransitionV71 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV71 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v71' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v71'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v71.img').read_bytes()
