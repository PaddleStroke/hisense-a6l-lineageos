...
PREVIOUS = '417164b78c3bc7c43eba3039caab240194b5a69000b78737c50c3503f398bcf9'

RECOVERIES = {PREVIOUS: 'verified-v71'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    ...
    if recovery_digest not in RECOVERIES:
        ...
        raise ValueError('Existing recovery is not the verified V71 predecessor')
