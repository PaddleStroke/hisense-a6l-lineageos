...
ARCHIVE = ROOT / 'firmware/extracted/keep-boot-domains-probe-20260915'
# Keep actively written QEMU logs on Linux ext4, not the Windows shared mount.
OUT = Path('/home/a6l/kernel/test-keep-boot-domains-20260915')
...
def main():
    ...
    result = {'scope': 'Diskless QEMU boot regression through init milestones and PID1; actual genpd branches are covered separately by extracted-function tests, not by this virtual hardware',
