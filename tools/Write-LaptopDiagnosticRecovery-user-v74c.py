...
"""
import argparse
from RecoveryTransitionV74C import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV74C import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v74c' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v74c'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v74c.img').read_bytes()
