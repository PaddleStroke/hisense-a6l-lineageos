...
"""
import argparse
from RecoveryTransitionV20 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV20 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v20' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v20'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v20.img').read_bytes()
