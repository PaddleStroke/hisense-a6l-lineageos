...
"""
import argparse
from RecoveryTransitionV37 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV37 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v37' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v37'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v37.img').read_bytes()
