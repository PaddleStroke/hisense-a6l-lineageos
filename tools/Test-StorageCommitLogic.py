"""Run the actual V30 C state machine against bounded fake SDHCI registers."""
from pathlib import Path
import re, subprocess, json
ROOT=Path(__file__).resolve().parents[1]
OUT=ROOT/'firmware/extracted/storage-commit-logic-v30-20260916'
source=ROOT/'tools/a6l-cmd0-commit-v30.c'
...
binary=Path('/tmp/a6l-v30-stage-test')
