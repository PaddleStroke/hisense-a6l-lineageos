...
"""
import argparse
from RecoveryTransitionV19 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV19 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v19' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v19'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v19.img').read_bytes()
