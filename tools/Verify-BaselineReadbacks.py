"""Independently verify all twelve copied V34 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV34 as transition
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v34'
