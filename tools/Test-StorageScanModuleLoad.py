...
KERNEL = ROOT / 'firmware/extracted/storage-scan-kernel-v24-20260916'
OUT = Path('/home/a6l/kernel/test-storage-scan-smoke-v24-20260916')
ARCHIVE = ROOT / 'firmware/extracted/storage-scan-smoke-v24-20260916'
