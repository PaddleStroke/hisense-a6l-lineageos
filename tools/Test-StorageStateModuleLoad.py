...
KERNEL = ROOT / 'firmware/extracted/storage-state-kernel-v32-20260917'
OUT = Path('/home/a6l/kernel/test-storage-state-smoke-v32-20260917')
ARCHIVE = ROOT / 'firmware/extracted/storage-state-smoke-v32-20260917'
