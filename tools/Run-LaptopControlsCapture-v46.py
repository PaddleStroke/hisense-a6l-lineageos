...
CAPTURE = ROOT / 'capture-controls-user-v46'
SERIAL = '1e529013'
...
def main():
    ...
    report = {'scope': 'Test installed V46 combined controls with unchanged V38 RAM userspace; one bootloader restart, no image writes',
    ...
    try:
        ...
        if not all(word in inhibition for word in ['A6L-v46', 'suspend', 'idle']):
            raise RuntimeError('V46 requires an active desktop idle/suspend inhibitor')
