...
"""
import argparse
from RecoveryTransitionV36 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV36 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v36' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v36'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v36.img').read_bytes()
