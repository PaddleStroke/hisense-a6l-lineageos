"""Independently verify all twelve copied V74R recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV74R as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = '417164b78c3bc7c43eba3039caab240194b5a69000b78737c50c3503f398bcf9'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v74r'
