...
PREVIOUS = 'd4fa4f8b5b50e3c7b9e123ad5cde913d5e5000fee3535620af4e50773b13d407'
RECOVERIES = {STOCK: 'stock', PREVIOUS: 'verified-v21'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    if recovery_digest not in RECOVERIES:
        raise ValueError('Existing recovery is neither exact stock nor the verified V21 image')
