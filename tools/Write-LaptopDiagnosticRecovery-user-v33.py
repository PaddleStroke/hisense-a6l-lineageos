...
"""
import argparse
from RecoveryTransitionV33 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV33 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v33' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v33'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v33.img').read_bytes()
