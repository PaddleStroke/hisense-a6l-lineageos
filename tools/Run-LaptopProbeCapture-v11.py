...
CAPTURE = ROOT / 'capture-probe-serial-v11'
SERIAL = '1e529013'
...
def main():
    ...
    try:
        ...
        if not (install.get('mode') == 'install-diagnostic' and install.get('readback_verified')
                ...
                and not install.get('error') and install.get('target_sha256') == '54ec8ad057bbb4bd52c63ad2c82ee68efd0a4828ff674cfdc51acbb41a12259a'):
