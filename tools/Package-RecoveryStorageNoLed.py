...
OLD = ROOT / 'firmware/extracted/recovery-probe-storage-core-v21-20260916'
RAM = ROOT / 'firmware/extracted/storage-noled-ramdisk-v22-20260916'
TEST = ROOT / 'firmware/extracted/storage-noled-probe-v22-20260916'
...
def main():
    ...
    assert test['passed']
    assert json.loads((ROOT / 'firmware/extracted/storage-noled-smoke-v22-20260916/report.json').read_text())['passed']
    ...
    assert sha(original) == 'd4fa4f8b5b50e3c7b9e123ad5cde913d5e5000fee3535620af4e50773b13d407'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V21 kernel/DT/command line/init preserved; only matching storage module adds A6L-only NO_LED quirk; regulator and storage settings unchanged',
