#!/usr/bin/env python3
"""V71 candidate: regression-check against the captured ABL routines (generated from the V46 test)."""
import hashlib
...
def main():
    ...
    try:
        ...
        expected_base = read_fdt((ROOT / 'firmware/extracted/recovery-v70-candidate-20260921/base.dtb').read_bytes())
