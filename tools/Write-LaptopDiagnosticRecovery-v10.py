...
from DiagnosticRecoveryProtocolV9 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v10' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v10'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-visible-userspace.img').read_bytes()
