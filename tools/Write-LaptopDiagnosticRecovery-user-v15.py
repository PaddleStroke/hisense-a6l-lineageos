...
"""
import argparse
from RecoveryTransitionV15 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV15 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v15' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v15'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v15.img').read_bytes()
