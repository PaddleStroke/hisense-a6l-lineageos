...
KERNEL = ROOT / 'firmware/extracted/storage-request-kernel-v26-20260916'
OUT = Path('/home/a6l/kernel/test-storage-request-smoke-v26-20260916')
ARCHIVE = ROOT / 'firmware/extracted/storage-request-smoke-v26-20260916'
