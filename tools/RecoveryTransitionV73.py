...
PREVIOUS = '6aa00cd02346a3f4312827bccb1db7df1a6ce3dd5147b721d2e43080ccc05ee4'

RECOVERIES = {PREVIOUS: 'verified-v72'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    ...
    if recovery_digest not in RECOVERIES:
        ...
        raise ValueError('Existing recovery is not the verified V72 predecessor')
