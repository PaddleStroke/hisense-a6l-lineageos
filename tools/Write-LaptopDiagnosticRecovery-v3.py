...
from DiagnosticRecoveryProtocolV2 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v3' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v3'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-v2-unsigned.img').read_bytes()
