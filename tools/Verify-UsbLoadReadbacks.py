"""Independently verify all twelve copied V17 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionV17 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = '50bd78a2a94a7d151defbe637b28492207bdd6b5f857cc413175b13535658c15'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-v17'
