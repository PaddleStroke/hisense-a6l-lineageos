...
"""
import argparse
from RecoveryTransitionV30 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV30 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v30' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v30'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v30.img').read_bytes()
