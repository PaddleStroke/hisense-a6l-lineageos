...
CAPTURE = ROOT / 'capture-graphics-user-v42'
SERIAL = '1e529013'
...
def main():
    ...
    report = {'scope': 'Reuse V38 recovery for V42 RAM graphics services; one bootloader restart, no image writes',
    ...
    try:
        ...
        if not all(word in inhibition for word in ['A6L-v42', 'suspend', 'idle']):
            raise RuntimeError('V42 requires an active desktop idle/suspend inhibitor')
