...
OLD = ROOT / 'firmware/extracted/recovery-probe-emmc-load-v35-20260917'
KERNEL = ROOT / 'firmware/extracted/baseline-7.2-kernel-20260917'
RAM = ROOT / 'firmware/extracted/baseline-7.2-ramdisk-20260917'
TEST = ROOT / 'firmware/extracted/baseline-7.2-probe-r2-20260917'
...
def main():
    ...
    assert sha(original) == '129621db2ac07c8c955426a5a974a4ffc8ba587eb883d0e6c76e6c01a2f76c00'
    ...
    report = {'packaging_passed': True, 'ready_to_flash': False,
              ...
              'scope': 'V36 Linux 7.2.3 with the same minimal A6L diagnostic support as V35 and both eMMC load permissions. Matching module; identical RAM init. No experimental MMC command, IRQ or barrier changes.',
