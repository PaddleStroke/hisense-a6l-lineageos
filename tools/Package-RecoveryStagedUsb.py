#!/usr/bin/env python3
"""Replace only the tested V12 diagnostic ramdisk; no phone access."""
import hashlib
...
OLD = ROOT / 'firmware/extracted/recovery-probe-usb-only-20260916'
RAM = ROOT / 'firmware/extracted/staged-usb-ramdisk-v13-20260916'
TEST = ROOT / 'firmware/extracted/staged-usb-probe-v13-20260916'
...
def main():
    ...
    assert sha(original) == '95c7ccaea2803f31db413ab905e4e9d045f0149d0b98e6b8627715a15486477d'
    ...
    report = dict(packaging_passed=True, ready_to_flash=False,
                  scope='Only RAM diagnostic replacement; kernel, DT, command line and load addresses unchanged from V12',
