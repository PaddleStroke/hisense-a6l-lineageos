...
from DiagnosticRecoveryProtocolV8 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v9' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v9'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-keep-boot-domains.img').read_bytes()
