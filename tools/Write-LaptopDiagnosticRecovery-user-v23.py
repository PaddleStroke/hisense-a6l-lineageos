...
"""
import argparse
from RecoveryTransitionV23 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV23 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v23' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v23'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v23.img').read_bytes()
