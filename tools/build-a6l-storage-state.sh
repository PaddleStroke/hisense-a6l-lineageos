...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-state-kernel-v32-20260917
...
exec > >(tee /home/a6l/logs/kernel-storage-state-v32.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-state-v32.log "$archive/build.log"
