...
"""
import argparse
from RecoveryTransitionV72 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV72 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v72' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v72'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v72.img').read_bytes()
