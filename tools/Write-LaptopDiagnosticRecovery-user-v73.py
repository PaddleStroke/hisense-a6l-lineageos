...
"""
import argparse
from RecoveryTransitionV73 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV73 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v73' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v73'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v73.img').read_bytes()
