...
KERNEL = ROOT / 'firmware/extracted/storage-cmd0-kernel-v25-20260916'
OUT = Path('/home/a6l/kernel/test-storage-cmd0-smoke-v25-20260916')
ARCHIVE = ROOT / 'firmware/extracted/storage-cmd0-smoke-v25-20260916'
