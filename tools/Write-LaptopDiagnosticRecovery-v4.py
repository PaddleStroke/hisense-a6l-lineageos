...
from DiagnosticRecoveryProtocolV3 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-v4' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-v4'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-earlycon.img').read_bytes()
