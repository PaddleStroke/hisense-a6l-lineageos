"""Independently verify all twelve copied BootM1 recovery readbacks on desktop."""
import argparse
import hashlib
import json
from pathlib import Path
import WindowsRecoveryReadOnly as baseline
import RecoveryTransitionBootM1 as transition

ROOT = Path(__file__).resolve().parents[1]
CANDIDATE = '259c43e3f4c32ab95db02467d1bd34f5f0b525414f074583a715acc131f8237e'
...
def main():
    ...
    capture = ROOT / f'captures/capture-diagnostic-{args.mode}-user-bootm1'
