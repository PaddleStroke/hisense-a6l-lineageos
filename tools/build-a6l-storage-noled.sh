...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-noled-kernel-v22-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-noled-v22.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-noled-v22.log "$archive/build.log"
printf '\nA6L_STORAGE_NOLED_KERNEL_BUILD_SUCCESS\n'
