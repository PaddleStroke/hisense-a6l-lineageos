...
"""
import argparse
from RecoveryTransitionV69 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV69 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v69' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v69'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v69.img').read_bytes()
