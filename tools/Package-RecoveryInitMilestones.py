#!/usr/bin/env python3
"""Package late-init milestones, retaining the physically tested V7 device tree."""
import gzip
import hashlib
...
OUT = ROOT / 'firmware/extracted/recovery-probe-init-milestones-20260915'
EARLY = ROOT / 'firmware/extracted/init-milestones-probe-20260915'
...
def main():
    ...
    report = dict(scope='Offline late-init milestone logging candidate; no phone access',
                  ...
                  only_gpio_reservation_changed=True, modern_overlay_passed=True,
                  remaining=['Run captured ABL overlay, selection, fixup and packaging checks',
                             ...
                             'Early LCD console already demonstrated physically; new milestone trace image still requires a physical trial'],
