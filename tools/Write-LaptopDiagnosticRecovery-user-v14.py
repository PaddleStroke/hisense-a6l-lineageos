...
"""
import argparse
from RecoveryTransitionV14 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV14 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v14' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v14'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v14.img').read_bytes()
