...
"""
import argparse
from RecoveryTransitionV32 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV32 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v32' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v32'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v32.img').read_bytes()
