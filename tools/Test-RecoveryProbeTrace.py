...
OUT = ROOT / 'firmware/extracted/recovery-probe-trace-20260915'
...
def main():
    ...
    try:
        ...
        assert sha(candidate) == '886baf8c66f85b199e3e0d8449731e5e98488d7c38641e7942f31ce54a216c38'
        ...
        assert sha(kernel) == '010467da4cf22105850d63d64ac5af5d48ad96132f1a98a1afb6eab17ddf3c68'
        ...
        vbmeta = (ROOT / 'captures/diagnostic-restore-laptop-v4-20260915/edl/vbmeta-after-write.bin').read_bytes()
