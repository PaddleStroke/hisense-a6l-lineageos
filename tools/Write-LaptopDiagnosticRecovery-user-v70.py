...
"""
import argparse
from RecoveryTransitionV70 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV70 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v70' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v70'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v70.img').read_bytes()
