...
"""
import argparse
from RecoveryTransitionV28 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV28 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v28' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v28'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v28.img').read_bytes()
