...
CAPTURE = ROOT / 'capture-present-user-v43'
SERIAL = '1e529013'
...
def main():
    ...
    report = {'scope': 'Reuse V38 recovery for V43 RAM graphics services; one bootloader restart, no image writes',
    ...
    try:
        ...
        if not all(word in inhibition for word in ['A6L-v43', 'suspend', 'idle']):
            raise RuntimeError('V43 requires an active desktop idle/suspend inhibitor')
