...
"""
import argparse
from RecoveryTransitionV17 import verify_transition, RECOVERIES
...
from DiagnosticRecoveryProtocolV17 import check_program_xml, program_recovery, verify_payload, TARGETS
...
def main():
    ...
    capture_name = 'capture-diagnostic-install-user-v17' if args.mode == 'install-diagnostic' else 'capture-diagnostic-restore-user-v17'
    ...
    try:
        ...
        payload = ((home / 'ram-staging/recovery-diagnostic-staged-usb-v17.img').read_bytes()
