...
archive=/mnt/c/Users/Pierre/Desktop/A6L/firmware/extracted/storage-hold-kernel-v28-20260916
...
exec > >(tee /home/a6l/logs/kernel-storage-hold-v28.log) 2>&1
...
cp /home/a6l/logs/kernel-storage-hold-v28.log "$archive/build.log"
printf '\nA6L_STORAGE_HOLD_KERNEL_BUILD_SUCCESS\n'
