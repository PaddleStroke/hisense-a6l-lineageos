...
KERNEL = ROOT / 'firmware/extracted/storage-stages-kernel-v29-20260916'
OUT = Path('/home/a6l/kernel/test-storage-stages-smoke-v29-20260916')
ARCHIVE = ROOT / 'firmware/extracted/storage-stages-smoke-v29-20260916'
