...
ARCHIVE = ROOT / 'firmware/extracted/pinctrl-trace-probe-20260915'
# Keep actively written QEMU logs on Linux ext4, not the Windows shared mount.
OUT = Path('/home/a6l/kernel/test-pinctrl-trace-20260915')
...
def main():
    ...
    result = {'scope': 'Diskless QEMU boot regression; does not exercise Qualcomm pinctrl hardware or the new hardware-path log statements',
