...
STOCK = '55ad4747ea8d83a32edb09eafb01772a3cb170378331cdea3d45cd5a8cb34dbc'

PREVIOUS = '55ad4747ea8d83a32edb09eafb01772a3cb170378331cdea3d45cd5a8cb34dbc'

RECOVERIES = {PREVIOUS: 'stock-boot-20260914'}
...
def verify_transition(recovery_digest, bcb, devinfo):
    ...
    if recovery_digest not in RECOVERIES:
        ...
        raise ValueError('Existing recovery is not the exact stock boot image from the 14 Sep backup')
