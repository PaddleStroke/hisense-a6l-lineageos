...
def main():
    ...
    try:
        ...
        assert sha(candidate) == '5abb7746867573e4afd1243713eb05e47d40b3d0d261ddee08c57b95b789486f'
        ...
        assert sha(kernel) == 'adb37cd28319c6076fc8fe143a215e31c7d15b0d9a07fc3e4c2cf7fa173772de'
